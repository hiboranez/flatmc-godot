...
func init(args):
	...
	update_target_pos()
	AudioManager.play_random_audio_at_position("sound/zombie/say", position, 1)
...
func get_damage(args):
	...
	if health <= 0:
		...
		AudioManager.play_random_audio_at_position("sound/zombie/hurt", position, 1)
...
func die(reason, object):
	...
	AudioManager.play_random_audio_at_position("sound/zombie/death", position, 1)
