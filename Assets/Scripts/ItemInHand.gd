...
func set_item_in_hand(got_item_name, is_update_player_inventory):
	if StaticLoad.get_item_model_type_by_name(got_item_name) == 0:
		...
		if is_update_player_inventory:
			...
			StaticLoad.game.inventory_player_model_item_in_hand.get_node("Bow").visible = false
		...
		if is_update_player_inventory:
			...
			StaticLoad.game.inventory_player_model_item_in_hand.get_node("ItemTop").visible = false
			if got_item_name.contains("BOW"):
				StaticLoad.game.inventory_player_model_item_in_hand.get_node("Bow").visible = true
				StaticLoad.game.inventory_player_model_item_in_hand.get_node("Tool").visible = false
			else:
				StaticLoad.game.inventory_player_model_item_in_hand.get_node("Bow").visible = false
