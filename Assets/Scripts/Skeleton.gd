...
func init(args):
	...
	update_target_pos()
	StaticLoad.game.sound_audio_manager.play_random_audio_at_position("skeleton", "say", position, 1)
...
func get_damage(args):
	...
	if health <= 0:
		...
		StaticLoad.game.sound_audio_manager.play_random_audio_at_position("skeleton", "hurt", position, 1)
